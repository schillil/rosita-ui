...
public class TruncatorRunnable implements Runnable {
	...
	public void run() {
		try {
			...
			String scriptfile = "./" + "truncate" + suffix; //Ensures that a Unix process can start, even if . is not in PATH
			ProcessBuilder pb = new ProcessBuilder(scriptPath + scriptfile, "forui");
