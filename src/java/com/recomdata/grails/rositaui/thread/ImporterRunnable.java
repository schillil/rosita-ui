...
public class ImporterRunnable implements Runnable {
	...
	public void run() {
		try {
			...
			String scriptfile = "./" + "loadmappings" + suffix; //Ensures that a Unix process can start, even if . is not in PATH
			...
			sig.sendSignal(jobId, 7, exitCode == 0);
		}
		catch (Exception e) {
