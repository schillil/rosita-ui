...
public class OmopProcessorRunnable implements Runnable {
	...
	public void run() {
		try {
			...
			String scriptfile = "./" + "processomop" + suffix; //Ensures that a Unix process can start, even if . is not in PATH
			...
			sig.sendSignal(jobId, 8, exitCode == 0);
		}
		catch (Exception e) {
